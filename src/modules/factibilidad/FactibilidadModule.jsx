                          ...
                          onClick={() => {
                            ...
                            exportarPDF({
                              ...
                              contenidoHTML: `
                                ...
                                ${r.premiosYAprovechamientos ? `<h2>Premios y aprovechamientos a convalidar</h2><p>${esc(r.premiosYAprovechamientos)}</p>` : ""}
                      ...
                      <div style={{ borderTop: `1px solid ${COLORS.border}30`, marginTop: "8px", paddingTop: "8px", fontSize: "11px" }}>
                        {r ? (
                          <>
                            ...
                            {r.premiosYAprovechamientos && (
                              <div style={{ marginTop: "8px" }}>
                                <div style={{ fontSize: "11px", fontWeight: 700, color: COLORS.gold, marginBottom: "3px" }}>💡 Premios y aprovechamientos a convalidar</div>
                                <div style={{ fontSize: "12px", color: COLORS.text, lineHeight: 1.5 }}>{r.premiosYAprovechamientos}</div>
                              </div>
                            )}
